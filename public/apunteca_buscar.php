                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body" align="center">
                    <form class="form-inline" role="form" id="formulario_busqueda">
                    	 <input type="text" class="form-control formulario" id="id_libro" placeholder="id del Libro">
                         <br>
                    	 <input type="text" class="form-control formulario" id="estante" placeholder="Estante">
                         <br>
						<input type="text" class="form-control formulario" id="numero" placeholder="Numero en el estante">
                        <br>
